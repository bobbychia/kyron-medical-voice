...
function getStepInstruction(step: string): string {
  const instructions: Record<string, string> = {
    ...
    collect_reason: `MANDATORY: Present our 4 specialties and ask which one applies. Say: "We can help with the following: 1. Bone & Joint Pain, 2. Heart & Chest concerns, 3. Headache & Neurology, 4. Stomach & Digestion. Which one best describes your concern?" Wait for their answer — do NOT ask for name or any other info yet.`,
